...
{
    v.YAxis = readRegister16(HMC5883L_REG_OUT_X_M) - yOffset;
    v.ZAxis = readRegister16(HMC5883L_REG_OUT_Y_M);
    v.XAxis = readRegister16(HMC5883L_REG_OUT_Z_M) - xOffset;
...
{
    v.YAxis = ((float)readRegister16(HMC5883L_REG_OUT_X_M) - yOffset) * mgPerDigit;
    v.ZAxis = (float)readRegister16(HMC5883L_REG_OUT_Y_M) * mgPerDigit;
    v.XAxis = ((float)readRegister16(HMC5883L_REG_OUT_Z_M) - xOffset) * mgPerDigit;
